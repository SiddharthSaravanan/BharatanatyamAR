...
def fingers (a,m):
    ...
    if a==2 :
        #Kartarimukha
        pb = ob.pose.bones.get("palm."+side)
        pb.rotation_euler = [math.radians(20.2-16),math.radians((16.9-14.4)*m),math.radians((59.2-51.6)*m)]
        
        pb = ob.pose.bones.get("thumb1."+side)
        pb.rotation_euler = [math.radians(-50.4+19.2),math.radians((-8.92-4.91)*m),math.radians((12+47.3)*m)]
        pb.location = [(0.005286-0.017015)*m,-0.038062+0.022855,-0.044142+0.054315]
        
        pb = ob.pose.bones.get("thumb2."+side)
        pb.rotation_euler = [math.radians(-38),math.radians(-3.26*m),math.radians(17.2*m)]
        
        pb = ob.pose.bones.get("index1."+side)
        pb.rotation_euler = [math.radians(-8.47+13.2),math.radians((-12.1+14.2)*m),math.radians((-1.81-4.88)*m)]
        pb.location = [(0.000355-0.010108)*m,-0.003317-0.003513,-0.029156+0.046629]
        
        pb = ob.pose.bones.get("middle1."+side)
        pb.rotation_euler = [math.radians(-6.61+6.62),math.radians((16+6.61)*m),math.radians((29.3-0.531)*m)]
        
        pb = ob.pose.bones.get("ring1."+side)
        pb.rotation_euler = [math.radians(-3.9),math.radians(22.9*m),math.radians(47.9*m)]
        pb.location = [(0.001575-0.000043)*m,0.005462-0.006383,0.022928-0.01972]
        ...
        pb.rotation_euler = [math.radians(-1.78-8.55),math.radians((18.8-4.64)*m),math.radians((46.2-0.932)*m)]
        pb.location = [(-0.006562-0.002588)*m,0.020608-0.009492,0.072343-0.0334464]
    ...
    if a==3:
        #Kutukamukha
        pb = ob.pose.bones.get("palm."+side)
        pb.rotation_euler = [math.radians(9.01-16),math.radians((1.73-14.4)*m),math.radians((-72.1+59.2)*m)]
        
        pb = ob.pose.bones.get("thumb1."+side)
        pb.rotation_euler = [math.radians(-20.2+19.2),math.radians((-11-4.91)*m),math.radians((8.74+47.3)*m)]
        pb.location = [(0.016017-0.017015)*m,0.018857+0.022855,-0.007888+0.054315]
        
        pb = ob.pose.bones.get("thumb2."+side)
        pb.rotation_euler = [math.radians(-46.6),math.radians(-60.3*m),math.radians(65.3*m)]
        
        pb = ob.pose.bones.get("index1."+side)
        pb.rotation_euler = [math.radians(3.81+13.2),math.radians((9.67+14.2)*m),math.radians((61.3-4.88)*m)]
        ...
        pb = ob.pose.bones.get("middle1."+side)
        pb.rotation_euler = [math.radians(8.73+6.62),math.radians((2.04+6.61)*m),math.radians((50-0.531)*m)]
        ...
        pb.location = [(0.002455-0.000043)*m,0.005537-0.006383,0.028158-0.01972]
        
        pb = ob.pose.bones.get("pinky1."+side)
        pb.rotation_euler = [math.radians(6.99-8.55),math.radians((13.8-4.64)*m),math.radians((-22.9-0.932)*m)]
        pb.location = [(0.006588-0.002588)*m,0.004933-0.009492,0.05633-0.0334464]
    ...
    if a==4 :
        ...
        pb = ob.pose.bones.get("thumb1."+side)
        pb.rotation_euler = [math.radians(23.2+19.2),math.radians((3.21-4.91)*m),math.radians((-3.98+47.3)*m)]
        pb.location = [(0.035344-0.017015)*m,-0.036544+0.022855,-0.006086+0.054315]
        
        pb = ob.pose.bones.get("thumb2."+side)
        pb.rotation_euler = [math.radians(20.9),math.radians(-5.05*m),math.radians(0.0151*m)]
        
        pb = ob.pose.bones.get("index1."+side)
        pb.rotation_euler = [math.radians(3.67+13.2),math.radians((10.2+14.2)*m),math.radians((76.5-4.88)*m)]
        pb.location = [(-0.009969-0.010108)*m,-0.000854-0.003513,-0.036625+0.046629]
        ...
        pb = ob.pose.bones.get("middle1."+side)
        pb.rotation_euler = [math.radians(1.95+6.62),math.radians((-0.099+6.61)*m),math.radians((71.7-0.531)*m)]
        ...
        pb.location = [(0.000803-0.000043)*m,-0.00226-0.006383,0.03448-0.01972]
        ...
        pb = ob.pose.bones.get("pinky1."+side)
        pb.rotation_euler = [math.radians(3.24-8.55),math.radians((-5-4.64)*m),math.radians((46.3-0.932)*m)]
        pb.location = [0.001553-0.002588*m,-0.009744-0.009492,0.071087-0.0334464]
    ...
    if (a==5):
        ...
        pb = ob.pose.bones.get("palm."+side)
        pb.rotation_euler = [math.radians(6.58-16),math.radians((-8.7-14.4)*m),math.radians((-74.1+59.2)*m)]
        
        pb = ob.pose.bones.get("thumb1."+side)
        pb.rotation_euler = [math.radians(-43.2+19.2),math.radians((-8.87-4.91)*m),math.radians((16.4+47.3)*m)]
        pb.location = [(0.005732-0.017015)*m,-0.049+0.022855,-0.0969+0.054315]
        
        pb = ob.pose.bones.get("thumb2."+side)
        pb.rotation_euler = [math.radians(-24.3),math.radians(-22*m),math.radians(4.75*m)]
        
        pb = ob.pose.bones.get("index1."+side)
        pb.rotation_euler = [math.radians(0.267+13.2),math.radians((-2.56+14.2)*m),math.radians((-11.9-4.88)*m)]
        pb.location = [-0.010108*m,-0.003513,0.046629]
        
        pb = ob.pose.bones.get("middle1."+side)
        pb.rotation_euler = [math.radians(0.152+6.62),math.radians((0.603+6.61)*m),math.radians((28.2-0.531)*m)]
        ...
        pb.location = [(-0.009325-0.000043)*m,-0.010571-0.006383,0.039031-0.01972]
        ...
        pb = ob.pose.bones.get("pinky1."+side)
        pb.rotation_euler = [math.radians(9.06-8.55),math.radians((0.45-4.64)*m),math.radians((14.1-0.932)*m)]
        pb.location = [(-0.014573-0.002588)*m,-0.019191-0.009492,0.056904-0.0334464]
    ...
    if a==6:
        ...
        pb = ob.pose.bones.get("thumb1."+side)
        pb.rotation_euler = [math.radians(-24.4+19.2),math.radians((-25.6-4.91)*m),math.radians((-10.7+47.3)*m)]
        pb.location = [(0.038993-0.017015)*m,0.021214+0.022855,-0.043467+0.054315]
        
        pb = ob.pose.bones.get("thumb2."+side)
        pb.rotation_euler = [math.radians(-13.6),math.radians(-32.4*m),math.radians(6.33*m)]
        
        pb = ob.pose.bones.get("index1."+side)
        pb.rotation_euler = [math.radians(-1.49+13.2),math.radians((-9.17+14.2)*m),math.radians((-10.4-4.88)*m)]
        ...
        pb = ob.pose.bones.get("middle1."+side)
        pb.rotation_euler = [math.radians(0.724+6.62),math.radians((1.15+6.61)*m),math.radians((64.2-0.531)*m)]
        ...
        pb = ob.pose.bones.get("pinky1."+side)
        pb.rotation_euler = [math.radians(7.02-8.55),math.radians((-3.01-4.64)*m),math.radians((47.1-0.932)*m)]
        pb.location = [(-0.014573-0.002588)*m,-0.019191-0.009492,0.056904-0.0334464]
    ...
    if a==7:
        ...
        pb = ob.pose.bones.get("index1."+side)
        pb.rotation_euler = [math.radians(1.86+13.2),math.radians((-6.54+14.2)*m),math.radians((-31.8-4.88)*m)]
        pb.location = [-0.010108*m,-0.003513,0.046629]
        ...
        pb = ob.pose.bones.get("pinky1."+side)
        pb.rotation_euler = [math.radians(-5.21-8.55),math.radians((-6.82-4.64)*m),math.radians((74.7-0.932)*m)]
...
def an(a,b):
    if b==1 or b==2:
        ...
        pb.rotation_euler = [math.radians(-38.6),math.radians(12.9),math.radians(46.9+9)]
        pb.location = [-0.41+0.51,0,0]
...
def lx(a,m):
        ...
        if a==3:
            pb.location = [pb.location[0]+(-1.8-5.41)*m,pb.location[1]+0,pb.location[2]+0]
        if a==2:
            pb.location = [pb.location[0]+(-0.8-5.41)*m,pb.location[1]+0,pb.location[2]+0]
        if a==1:
            pb.location = [pb.location[0]+(-0.35-5.41)*m,pb.location[1]+0,pb.location[2]+0]
        if a==0:
            pb.location = [pb.location[0]+0,pb.location[1]+0,pb.location[2]+0]
        if a==-2:
            pb.location = [pb.location[0]+(24.15-5.41)*m,pb.location[1]+0,pb.location[2]+0]
